...
public class TreeGraph <T> implements Graph <T> {
    private final TreeMap<T, TreeSet<T>> data;
     ...
     * @return a boolean indicating whether object1 connects to object2
     */
    @Override
