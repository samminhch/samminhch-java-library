...
//                    "0 or greater than the number of sig figs a number has", decimalsToKeep));
    ...
    //Please fix this method this is so shit lol
     ...
     * @return <code>int</code>-- The greatest common denominator between two integers;
     * or -1 if the sum of the parameters is greater than Integer.MAX_VALUE.
     */
